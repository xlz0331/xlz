 ...
 * @since 2018-03-16
 */
public class OrgDeptDto extends BaseDto implements Serializable {
	...
	private String specialJobs;
	
	private String state;
	
	private List<OrgJobDto> jobs;
	...
	public String getSpecialJobs() {
		return specialJobs;
	}

	public void setSpecialJobs(String specialJobs) {
		this.specialJobs = specialJobs;
	}

	public List<OrgJobDto> getJobs() {
		return jobs;
	}

	public void setJobs(List<OrgJobDto> jobs) {
		this.jobs = jobs;
	}
