 ...
 * @since 2018-03-15
 */
public class OrgJobDto extends BaseDto implements Serializable {
	...
	private String dataType; //数据类型  save、update、delete
	
	private String managDepts;
	
	private String managDeptNames;
	...
	public String getManagDeptNames() {
		return managDeptNames;
	}

	public void setManagDeptNames(String managDeptNames) {
		this.managDeptNames = managDeptNames;
	}
